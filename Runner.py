...
class Game:
    """
    РћСЃРЅРѕРІРЅРѕР№ РєР»Р°СЃСЃ РёРіСЂС‹.
    """
    ...
    def __init__(self):
        ...
        # Р¤Р»Р°Рі СЂР°Р±РѕС‚С‹ РёРіСЂС‹
        self.RUN = True

        # РЎРѕРєРєРµС‚ РґР»СЏ UDP СЃРѕРµРґРёРЅРµРЅРёСЏ
        self.sock_udp = None # socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        # self.sock_udp.settimeout(1)
        self.run_udp = False

        # РЎРѕРєРєРµС‚ РґР»СЏ TCP СЃРѕРµРґРёРЅРµРЅРёСЏ
        self.sock_tcp = None # socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        # self.sock_tcp.settimeout(1)
        self.run_tcp = False

        # Р’СЃРїРѕРјРѕРіР°С‚РµР»СЊРЅС‹Рµ "Р¤Р»Р°РіРё"
        self.show_message_frame = True
        self.show_glow = False

        # РћРєРЅРѕ СЃРѕРѕР±С‰РµРЅРёР№
        ...
        # РР·РѕР±СЂР°Р¶РµРЅРёРµ РёРєРѕРЅРѕРє
        self.icon = Game.icon_init()

        # РћСЃРЅРѕРІРЅРѕРµ РёРіСЂРѕРІРѕРµ РѕРєРЅРѕ
        self.screen = Game.pygame_init()

        # РћРєРЅРѕ РІРІРѕРґР°
        self.dial_frame = pygame.image.load('IMG/Frames/Frame_dial.png')

        # Р”СЂСѓРіРёРµ РёРіСЂРѕРєРё
        self.friends = {}

        # Р›РѕРіРёРЅ РёРіСЂРѕРєР°
        self.login = ''

        # РћСЃРЅРѕРІРЅРѕР№ РёРіСЂРѕРє
        self.current_player = None

        # РќРѕРјРµСЂ РѕСЃРЅРѕРІРЅРѕРіРѕ РёРіСЂРѕРєР° СЃСЂРµРґРё РіРµСЂРѕРµРІ
        self.num_player = 0

        # РђРЅРёРјР°С†РёСЏ РІСЃРµС… РіРµСЂРѕРµРІ
        self.players = []

        # РќР°С‡Р°Р»СЊРЅР°СЏ РєР°СЂС‚Р°
        self.current_map = 'TilesMap/Town.tmx'

        # РљР»Р°СЃСЃ РіРµСЂРѕРµРІ, РІ РѕС‚Р»РёС‡Р°Рµ РѕС‚ players РЅРµСЃРµС‚ РІ СЃРµР±Рµ С‚РѕР»СЊРєРѕ РёРЅС„РѕСЂРјР°С†РёСЋ Рѕ С…Р°СЂР°РєС‚РµСЂРёСЃС‚РёРєР°С….
        self.heroes = []

        # Р”РµРЅСЊРіРё
        self.money = 0

        # Р¤Р»Р°Рі РѕРЅР»Р°Р№РЅР°. РњРѕР¶РЅРѕ СЃРєР°Р·Р°С‚СЊ РѕР±СЉРµРґРµРЅРµРЅРёРµ run_tcp Рё run_udp
        self.online = False
    ...
    def load_data(self, *args):
        """
        РћР±СЂР°Р±РѕС‚РєР° РґР°РЅРЅС‹С… РїСЂРёС€РµРґС€РёС… РёР· СЃРѕС…СЂР°РЅРµРЅРёСЏ
        :param args: РњР°СЃСЃРёРІ РґР°РЅРЅС‹С… РёР· Р±Р°Р·С‹ РґР°РЅРЅС‹С…
        :return: None
        """
        self.current_map = args[2]
        self.players = [Life(args[6]), Life(args[28]), Life(args[50]), Life(args[72])]
        # Р’ Р±СѓРґСѓС‰РµРј СЃРґРµР»Р°С‚СЊ РІС‹Р±РѕСЂ Р¶РёРІРѕРіРѕ РіРµСЂРѕСЏ
        self.heroes = [
    ...
    def load(self) -> str:
        """
        РЎС‚СЂР°РЅРёС†Р° СЃРѕС…СЂР°РЅРµРЅРёСЏ
        :return: РЎС‚СЂРѕРєР° СЃР»РµРґСѓСЋС‰РµРіРѕ СЃРѕСЃС‚РѕСЏРЅРёСЏ
        """
        database = sql.DB()
    ...
    def save_data(self) -> list:
        """
        РЎРѕР·РґР°РЅРёРµ РґР°РЅРЅС‹С… РґР»СЏ СЃРѕС…СЂР°РЅРµРЅРёСЏ
        :return: РЎРїРёСЃРѕРє РґР°РЅРЅС‹С…
        """
        i = 0
        buf = []
        for h in self.heroes:
    ...
    def menu(self) -> str:
        """
        РћС‚РІРµС‡Р°РµС‚ Р·Р° РїСЂРѕСЂРёСЃРѕРІРєСѓ РјРµРЅСЋ
        :return: РЎС‚СЂРѕРєР° СЃР»РµРґСѓСЋС‰РµРіРѕ СЃРѕСЃС‚РѕСЏРЅРёСЏ
        """
                ...
                if e.type == pygame.QUIT:
                    ...
                    if e.key == pygame.K_RETURN:
                        if i_a == 0:
                            ...
                            # РќР°СЃС‚СЂРѕР№РєРё
                            # РџРѕРєР° РЅРµ РґРѕР±Р°РІР»РµРЅС‹ РІ Р±СѓРґСѓС‰РµРј Р±СѓРґРµС‚ РЅР°СЃС‚СЂРѕР№РєР° РіСЂР°С„РёРєРё.
                            pass
                        elif i_a == 3:
                            # РђРІС‚РѕСЂС‹
                            pass
    ...
    def option(self) -> str:
        """
        РћС‚РІРµС‡Р°РµС‚ Р·Р° РїСЂРѕСЂРёСЃРѕРІРєСѓ РЅР°СЃС‚СЂРѕРµРє РІРѕ РІСЂРµРјСЏ РёРіСЂС‹
        (Р’РєР»СЋС‡Р°РµС‚СЃСЏ РїСЂРё РЅР°Р¶Р°С‚РёРё ESC РІ РёРіСЂРµ, РєСЂРѕРјРµ Р±РёС‚РІС‹).
        :return: РЎС‚СЂРѕРєР° СЃР»РµРґСѓСЋС‰РµРіРѕ СЃРѕСЃС‚РѕСЏРЅРёСЏ
        """
        check_pos = [(835, 242),
                     (835, 285)]
    ...
    def check_obj(self, terra: Map) -> str:
        """
        РџСЂРѕРІРµСЂСЏРµС‚ РѕР±СЉРµРєС‚С‹ РЅР° РєР°СЂС‚Рµ.
        Gate-РІС…РѕРґ РєСѓРґР° Р»РёР±Рѕ.
        Exit-РІС‹С…РѕРґ РёР· РїРѕРјРµС‰РµРЅРёСЏ.
        :param terra: РўРµРєСѓС‰Р°СЏ РєР°СЂС‚Р°
        :return: РЎС‚СЂРѕРєР° СЃР»РµРґСѓСЋС‰РµРіРѕ СЃРѕСЃС‚РѕСЏРЅРёСЏ
        """
        if not terra.obj:
            return 'OK'
    ...
    def map_run(self, terra: Map) -> str:
        """
        РћСЃРЅРѕРІРЅРѕР№ РёРіСЂРѕРІРѕР№ С†РёРєР» РЅР° РєР°СЂС‚Рµ.
        :param terra: РўРµРєСѓС‰Р°СЏ РєР°СЂС‚Р°
        :return: РЎС‚СЂРѕРєР° СЃР»РµРґСѓСЋС‰РµРіРѕ СЃРѕСЃС‚РѕСЏРЅРёСЏ
        """
        k = 0
    ...
    def pygame_init() -> pygame.Surface:
        """
        РЎС‚Р°С‚РёС‡РµСЃРєРёР№ РјРµС‚РѕРґ РґР»СЏ СЃРѕР·РґР°РЅРёСЏ РѕСЃРЅРѕРІРЅРѕРіРѕ РѕРєРЅР° Рё РёРЅРёС†РёР°Р»РёР·Р°С†РёРё Pygame
        :return: РћСЃРЅРѕРІРЅРѕРµ РѕРєРЅРѕ
        """
        pygame.init()
        pygame.font.init()
    ...
    def icon_init() -> dict:
        """
        РЎС‚Р°С‚РёС‡РµСЃРєРёР№ РјРµС‚РѕРґ РґР»СЏ СЃРѕР·РґР°РЅРёСЏ СЃР»РѕРІР°СЂСЏ РјРµР»РєРёС… РёР·РѕР±СЂР°Р¶РµРЅРёР№.
        :return: РЎР»РѕРІР°СЂСЊ РёР·РѕР±СЂР°Р¶РµРЅРёР№ РїРѕ РЅР°Р·РІР°РЅРёСЋ
        """
    ...
    def settings_init() -> dict:
        """
        РЎС‚Р°С‚РёС‡РµСЃРєРёР№ РјРµС‚РѕРґ РґР»СЏ СЃРѕР·РґР°РЅРёСЏ СЃР»РѕРІР°СЂСЏ "С„Р»Р°РіРѕРІ".
        :return: РЎР»РѕРІР°СЂСЊ С„Р»Р°РіРѕРІ РїРѕ РЅР°Р·РІР°РЅРёСЋ
        """
        return {
            'message_frame': True,
            'glow': False,
    ...
    def new_msg(color=(255, 255, 255), font_size=18, max_len=64) -> pygame_textinput.TextInput:
        """
        РЎС‚Р°С‚РёС‡РµСЃРєРёР№ РјРµС‚РѕРґ РІРѕР·РІСЂР°С‰Р°СЋС‰РёР№ РЅРѕРІСѓСЋ СЃС‚СЂРѕРєСѓ РІРІРѕРґР°.
        :return: РќРѕРІР°СЏ СЃС‚СЂРѕРєР° РІРІРѕРґР°
        """
    ...
    def listen_udp(self):
        """
        Р¦РёРєР» РїСЂРѕР»СѓС€РєРё UDP СЃРѕРµРґРёРЅРµРЅРёСЏ
        :return: None
        """
        self.run_udp = True
    ...
    def listen_tcp(self):
        """
        Р¦РёРєР» РїСЂРѕСЃР»СѓС€РєРё TCP СЃРѕРµРґРёРЅРµРЅРёСЏ
        :return: None
        """
        self.run_tcp = True
    ...
    def start(self) -> str:
        """
        Р—Р°РїСѓСЃРє РІСЃРµР№ РёРіСЂС‹.
        :return: РЎС‚СЂРѕРєР° СЃР»РµРґСѓС‰РµРіРѕ СЃРѕСЃС‚РѕСЏРЅРёСЏ
        """
    ...
    def check_login(self, login: str) -> bool:
        ...
        :param login: РЎР°Рј Р»РѕРіРёРЅ
        :return: РњРѕР¶РЅРѕ РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ РёР»Рё РЅРµС‚
        """
    ...
    def new_authorization(self) -> str:
        """
        РЎС‚СЂР°РЅРёС†Р° Р°РІС‚РѕСЂРёР·Р°С†РёРё, РґР»СЏ РЅРѕРІРѕРіРѕ РёРіСЂРѕРєР°
        :return: РЎС‚СЂРѕРєР° СЃР»РµРґСѓС‰РµРіРѕ СЃРѕСЃС‚РѕСЏРЅРёСЏ
        """
        try:
            os.mkdir('Save')
    ...
    def view_logo(self):
        """
        РџРѕРєР°Р· Р»РѕРіРѕС‚РёРїР° РЅР° 2 СЃРµРєСѓРЅРґС‹
        :return: None
        """
    ...
    def init_hero(key: str) -> Hero:
        """
        РРЅРёС†РёР°С†РёСЏ РіРµСЂРѕСЏ Р±РµР· РёРјРµРЅРё
        :param key: ID РіРµСЂРѕСЏ, С‚РѕС‚ Р¶Рµ С‡С‚Рѕ Рё РІ Life
        :return: Hero
        """
    ...
    def init_person(self) -> str:
        """
        РћРєРЅРѕ СЃРѕР·РґР°РЅРёСЏ РїРµСЂРѕСЃРЅР°Р¶РµР№
        :return: РЎС‚СЂРѕРєР° СЃР»РµРґСѓСЋС‰РµРіРѕ СЃРѕСЃС‚РѕСЏРЅРёСЏ
        """
        flag_duplicate = 0
    ...
    def game_over(self):
        """
        РџРѕРєР°Р· РѕРєРѕРЅС‡Р°РЅРёСЏ РёРіСЂС‹
        :return: None
        """
